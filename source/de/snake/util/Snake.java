...
import de.snake.swing.JGameplayPanel;
import de.snake.swing.JMainFrame;
import de.snake.swing.JScorePanel;
...
public class Snake implements Runnable {
	...
	private List<Cell> snakeBody, defaultBody;
	
	private int score, speed;
	
	private String name, move = LEFT, currentDirection = LEFT;
	...
	private Snake(int speed, JGameplayPanel jGamePnl, JScorePanel jScorePnl, Randomiser randomiser) {
		...
		snakeBody = new CopyOnWriteArrayList<>();// LinkedList<>();
		name = "Default";
	...
	public static Snake createSnake(int speed, JGameplayPanel jGamePnl, JScorePanel jScorePnl,
		...
		if(snake == null) {
			...
			System.out.println("Create snake at speed: " + speed);
		}
