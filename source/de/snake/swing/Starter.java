...
import de.snake.util.Randomiser;
import de.snake.util.Snake;
				...
				public void keyPressed(KeyEvent e) {
					...
					if(e.getKeyCode() == KeyEvent.VK_UP) {
						...
						if(menuMode) {
							...
							if(snake.getSnakeBody().get(0).gexX() > 0 && snake.getSnakeBody().get(0).gexX() <= JMainFrame.WIDTH &&
